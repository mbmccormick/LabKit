  ...
  return (
    <article class="prose">
      ...
      <p class="muted small">
        ...
        and is available at no cost under the license at <a href="https://loinc.org/license">https://loinc.org/license</a>.
        LOINC® is a registered United States trademark of Regenstrief Institute, Inc.
      </p>
      <p class="muted small">
        Apple, the Apple logo, Apple Health, and iPhone are trademarks of Apple Inc., registered in the U.S. and other
        countries.
      </p>
    </article>
  );
